...
tags: ["tirzepatide", "oral-delivery", "drug-delivery", "phase-1", "clinical-trial"]
excerpt: "Eli Lilly initiates Phase 1 trials for oral tirzepatide formulation using novel absorption enhancement technology, potentially eliminating the need for weekly injections."
relatedPeptides: ["tirzepatide", "semaglutide", "orforglipron"]
relatedGlossary: ["glp-1", "gip", "bioavailability"]
sources:
