...
sources:
  - id: attain-1-results
    ...
    verified: false
    note: >-
      Stored NCT NCT05654623 registers a different study ("A Study to Learn
      About a New Medicine Called Vepdegestrant (ARV-471, P"); removed as
      unverifiable.
  ...
  - id: phase2-orforglipron
    ...
    verified: false
    note: >-
      The DOI previously stored here (10.1056/NEJMoa2306449) does not resolve;
      neither did the one on the ATTAIN-1 citation above. The identifier has been
      removed rather than replaced by a guess. The Phase 2 programme is real and
      this lead is kept for re-citation once the correct record is confirmed.
evidenceLevel: high
featured: false
metaTitle: 'ATTAIN-1 Results: Orforglipron 11.2% Weight Loss'
metaDescription: >-
  ATTAIN-1 Phase 3 trial shows oral orforglipron achieves 11.2% weight loss
  rivaling injectable GLP-1 options. Full trial data and what it means for
  patients.
---
...
achieving a reduction of 15% or more [nejm-orforglipron].
...
- **FDA approval:** granted 1 April 2026 under NDA 220934, marketed as Foundayo
