...
| **Dosing Frequency** | Monthly | Weekly |
...
| **Titration** | Protocol not finalized | Yes (2.5mg start, titrate up) |
| **Max dose** | TBD | 15mg weekly |
| **Injections/year** | ~12 | ~52 |

### Convenience Factor

The monthly dosing of maritide is a potential significant advantage:
- Fewer injections per year (12 vs 52)
- Less frequent remembering/scheduling
- May improve adherence
- However: if side effects occur, they may last longer
