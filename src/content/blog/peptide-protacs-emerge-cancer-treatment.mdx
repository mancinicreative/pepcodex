...
tags: ["protacs", "cancer", "peptide-conjugates", "oncology"]
excerpt: "Researchers demonstrate peptide-based PROTACs can selectively degrade previously undruggable cancer targets, opening new therapeutic possibilities beyond traditional small molecule approaches."
relatedPeptides: ["peptide-drug-conjugates"]
relatedGlossary: ["protac", "ubiquitin", "targeted-protein-degradation"]
sources:
