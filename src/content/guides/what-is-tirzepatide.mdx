...
summary: "An introduction to tirzepatide, a dual GIP/GLP-1 receptor agonist used for type 2 diabetes and weight management. Learn how it works, what the research shows, and key facts you should know."
metaTitle: "What is Tirzepatide? (2026 Guide)"
...
|-------|------------|-------------------------|
| SURMOUNT-1 | Obesity, no diabetes | 20.9% of body weight |
...
For complete safety information, see our [GLP-1 Safety Overview](/safety/glp1-safety-overview).
...
- **[GLP-1 Safety Overview](/safety/glp1-safety-overview)** - Detailed safety information
