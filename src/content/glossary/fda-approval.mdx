...
relatedTerms: ["clinical-trial", "off-label-use", "investigational"]
category: "regulatory"
lastUpdated: 2026-05-14
metaTitle: "FDA Drug Approval: Definition, Process & What It Means"
metaDescription: "FDA approval is the formal U.S. authorization allowing a drug to be marketed after proving safety and efficacy through clinical trials. Learn the full approval process, timelines, and what it does and doesn't guarantee."
---

## Quick Answer

**FDA approval** is the formal authorization by the U.S. Food and Drug Administration that allows a drug to be marketed and prescribed for specific conditions. It means the drug has completed rigorous preclinical and clinical testing—typically including Phase 1 through Phase 3 trials in thousands of patients—demonstrating that its benefits outweigh its risks for the approved use. Approval does not mean a drug is risk-free; it means the evidence supports its use under the conditions described in the official labeling.
