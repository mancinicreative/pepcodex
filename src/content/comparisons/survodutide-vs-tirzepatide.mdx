...
faqs:
  ...
  - question: Are Survodutide and Tirzepatide FDA approved?
    answer: >-
      Survodutide is not FDA-approved; it has no application in Drugs@FDA and
      remains investigational. It holds FDA Breakthrough Therapy designation
      for MASH, which is a development-programme designation and not an
      approval. Tirzepatide is FDA-approved as Mounjaro for type 2 diabetes
      and as Zepbound for chronic weight management and for moderate-to-severe
...
|---------|-------------|-------------|
| **Max Weight Loss** | ~19.5% (Phase 2) | ~20.9% (Phase 3) |
...
| **Obesity Approval** | Not approved; no application in Drugs@FDA | Yes (Zepbound) |
| **T2D Approval** | Not approved; no application in Drugs@FDA | Yes (Mounjaro) |
| **NASH Indication** | Primary focus | Under investigation |
| **First Approval** | None; not approved as of August 2026 | 2022 |
