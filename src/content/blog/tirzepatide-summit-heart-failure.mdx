...
tags:
  ...
  - hfpef
excerpt: >-
  SUMMIT trial demonstrates tirzepatide reduces heart failure events by 38% in
  patients with HFpEF and obesity, establishing cardiovascular benefits beyond
  weight loss.
relatedPeptides:
  - tirzepatide
  - semaglutide
...
sources:
  ...
  - id: summit-cmr-substudy
    title: >-
      Tirzepatide Reduces LV Mass and Paracardiac Adipose Tissue in
      Obesity-Related Heart Failure: SUMMIT CMR Substudy
  ...
  - id: hfpef-review
    title: >-
      Reaching the SUMMIT? Benefits and potential risks associated with the use
      of tirzepatide in heart failure with preserved ejection fraction
    url: 'https://doi.org/10.1016/j.medj.2024.12.004'
    pmid: '39954669'
    doi: 10.1016/j.medj.2024.12.004
    type: journal
    verifiedAt: '2026-08-17'
evidenceLevel: high
featured: false
metaTitle: "SUMMIT Trial: Tirzepatide Cuts Heart Failure 38%"
metaDescription: >-
  SUMMIT trial shows tirzepatide reduces heart failure events by 38% in HFpEF
  patients with obesity. Evidence of cardiovascular benefits beyond weight loss.
---
...
The reduction in heart failure hospitalizations was particularly striking, with nearly half as many hospitalizations in the tirzepatide group [summit-trial-results]. A cardiac-MRI substudy separately reported reductions in left ventricular mass and paracardiac adipose tissue, which is the structural correlate of the clinical result [summit-cmr-substudy].
...
Consistent with tirzepatide's known metabolic effects. Every figure below is from the SUMMIT HFpEF population at 52 weeks, not from an obesity trial — SUMMIT enrolled people with heart failure and obesity, and its weight results should not be read as the drug's general weight-loss effect.

| Outcome (SUMMIT, HFpEF + obesity, 52 weeks) | Tirzepatide | Placebo |
|---|---|---|
| Body weight change | −15.7% | −2.1% |
| Waist circumference | −14.2 cm | −2.8 cm |
| HbA1c, diabetic subgroup | −2.1% | −0.3% |
| Systolic blood pressure | −7.4 mmHg | −1.2 mmHg |

For tirzepatide's weight-loss results in an obesity population, see the [tirzepatide dossier](/peptides/tirzepatide), which reports the SURMOUNT programme separately.
