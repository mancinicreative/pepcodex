---
title: 'Survodutide MASH: 62% Phase 2 Resolution, Then Two Phase 3 Estimands'
...
tags:
  ...
  - dual-agonist
excerpt: >-
  Phase 2 biopsy data: 62% MASH resolution at 4.8 mg. SYNCHRONIZE-MASLD then
  published two estimands (−8.7% treatment-regimen vs −12.2% efficacy). The
  converting pair on this site is cagrilintide vs survodutide, not a new blog
  matchup.
relatedPeptides:
  - survodutide
  - semaglutide
...
sources:
  ...
  - id: synchronize-masld
    ...
    url: 'https://doi.org/10.1038/s41591-026-04479-3'
    pmid: '42252333'
  ...
  - id: synchronize-1
    title: >-
      SYNCHRONIZE-1: A Study to Test Whether Survodutide (BI 456906) Helps People
      Living With Obesity
  ...
  - id: liverage
    title: >-
      LIVERAGE: A Study to Test Whether Survodutide Helps People With Metabolic
  ...
  - id: nct04771273
    title: >-
      A Study to Test Safety and Efficacy of Survodutide (BI456906) in Adults
      With Non-alcoholic Steatohepatitis (NASH) and Fibrosis (F1-F3)
...
featured: false
metaTitle: 'Survodutide MASH: 62% Resolution, Then −8.7%'
metaDescription: >-
  Phase 2: 62% MASH resolution at 4.8 mg. SYNCHRONIZE-MASLD treatment-regimen
  −8.7% weight. Side-by-side with cagrilintide is the existing compare page.
---
...
The full compound record is in the [survodutide dossier](/peptides/survodutide); the closest published comparators are [semaglutide](/peptides/semaglutide) and, for the glucagon-containing class, [retatrutide](/peptides/retatrutide) and [pemvidutide](/peptides/pemvidutide). The converting pair on this site is [cagrilintide vs survodutide](/compare/cagrilintide-vs-survodutide) — amylin versus GLP-1/glucagon, not a MASH head-to-head.
...
## The Phase 3 Has Now Read Out

**SYNCHRONIZE-MASLD**, a randomized, double-blind, placebo-controlled phase 3 trial in 216 adults with obesity and metabolic dysfunction-associated steatotic liver disease, published in *Nature Medicine* in 2026 over 48 weeks. Both co-primary endpoints were met [synchronize-masld].

It also reports two different numbers for the same endpoints, and says so explicitly:
...
The treatment-regimen estimand counts every randomised participant regardless of adherence; the efficacy estimand models the result as though everyone stayed on treatment. The gap between them here is 3.5 percentage points on body weight and nearly 16 points on liver-fat response. Coverage that quotes only the larger figure is not wrong about the trial — it is quoting the analysis that flatters the drug.

Note the population difference too: SYNCHRONIZE-MASLD enrolled people with MASLD, not the biopsy-confirmed MASH-with-fibrosis population of the phase 2 trial. It does not directly confirm or refute the 62% histological resolution figure.

### The Rest of the Phase 3 Programme

Boehringer Ingelheim's phase 3 programme for survodutide runs under the **SYNCHRONIZE** name in obesity — SYNCHRONIZE-1 ([NCT06066515](https://clinicaltrials.gov/study/NCT06066515)) and SYNCHRONIZE-2 ([NCT06066528](https://clinicaltrials.gov/study/NCT06066528)), both completed — and under **LIVERAGE** ([NCT06632444](https://clinicaltrials.gov/study/NCT06632444)) and LIVERAGE-Cirrhosis ([NCT06632457](https://clinicaltrials.gov/study/NCT06632457)) in liver disease, both recruiting [synchronize-1] [liverage]. The liver programme is where the confirmatory histology and outcome data for MASH will come from.
...
3. **Phase 3 histology still pending:** SYNCHRONIZE-MASLD has published, but in a MASLD population with imaging endpoints; the LIVERAGE programme carries the biopsy-confirmed MASH endpoints regulators require
