...
tags:
  ...
  - faq
excerpt: >-
  An honest evidence review of BPC-157 safety. What human data exists, what is
  still only in animals, what the FDA's stance is, and what the significant gaps
  in our knowledge mean for evaluating this widely discussed peptide.
relatedPeptides:
  - bpc-157
peptide: bpc-157
...
metaDescription: >-
  Honest evidence review of BPC-157 safety. What human trials show, gaps in
  research, regulatory status, and what you should know before considering this
  peptide.
sources:
  - id: pmid-30915550
    title: >-
      Gastric pentadecapeptide BPC 157 and its role in accelerating
  ...
  - id: pmid-28013436
    title: >-
      BPC-157 promotes angiogenesis through VEGFR2 pathway activation in
  ...
  - id: nct05765513
    title: >-
      Safety and Pharmacokinetics of Intravenous BPC-157 in Healthy Volunteers
      (NCT05765513)
    type: trial
    verified: false
    note: >-
      Stored NCT NCT05765513 registers a different study ("HA35 Treatment the
      Gingival Discomfort as Well as Gingival Redness and"); removed as
      unverifiable.
  - id: pmid-21030672
