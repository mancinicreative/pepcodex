...
excerpt: >-
  ...
  FDA-approved and late-stage clinical compounds, ranked by strength of evidence
...
difficulty: beginner
evidenceLevel: high
metaTitle: 'Best Peptides for Weight Loss 2026: Evidence Rankings'
metaDescription: >-
...
sources:
  ...
  - id: pmid-39107523
    title: >-
      Tirzepatide vs Semaglutide Once Weekly in Patients with Obesity —
      SURMOUNT-5 (Garvey et al., 2024)
    type: journal
    verified: false
    note: >-
  ...
  - id: pmid-25673378
    title: >-
      Liraglutide 3.0 mg for Weight Management — SCALE Obesity trial (Pi-Sunyer
      et al., 2015)
    type: journal
    verified: false
    note: >-
...
- **SURMOUNT-1 trial:** 20.9% mean weight loss at 72 weeks with the 15mg dose in adults with obesity (N=2,539) [pmid-35658024]. Over 60% of participants achieved 20% or greater weight loss.
...
- **REDEFINE-1 trial:** estimated mean weight change of −20.4% at 68 weeks versus −3.0% with placebo (treatment-policy estimand). A higher figure of 22.7% is sometimes quoted; that is the trial-product estimand, which models results as if everyone stayed on treatment, and it is not the primary published result.
