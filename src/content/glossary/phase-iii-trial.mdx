...
| Trial | Population | Key Result |
|-------|------------|------------|
| SURMOUNT-1 | Adults with obesity | Up to 20.9% weight loss |
| SURMOUNT-2 | Type 2 diabetes + obesity | Up to 14.7% weight loss |
| SURMOUNT-3 | With lead-in period | −18.4% from randomization (additional to the ≥5% lost in lead-in) |
