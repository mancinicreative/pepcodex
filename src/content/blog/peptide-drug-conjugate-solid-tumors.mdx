...
tags: ["peptide-drug-conjugate", "oncology", "solid-tumors", "targeted-therapy"]
excerpt: "A novel peptide-drug conjugate platform demonstrates promising efficacy across multiple solid tumor types, expanding the targeted delivery approach beyond antibody-drug conjugates."
relatedPeptides: ["bt5528", "zelenectide-pevedotin"]
relatedGlossary: ["clinical-trial", "mechanism-of-action", "apoptosis"]
sources:
