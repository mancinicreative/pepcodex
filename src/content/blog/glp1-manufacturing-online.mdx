...
**A note on figures.** An earlier version of this article listed specific facilities, their operational dates, and percentage capacity increases for Novo Nordisk and Eli Lilly. Those specifics could not be traced to company announcements and have been removed. What is documented is the direction of travel, not the numbers.

### Capacity Expansion

Both Novo Nordisk and Eli Lilly have made large, publicly announced capital commitments to manufacturing infrastructure — spanning active pharmaceutical ingredient synthesis, fill-finish capacity, and contract manufacturing partnerships across multiple regions.

The clearest evidence that capacity caught up with demand is regulatory rather than corporate: the FDA declared the tirzepatide injection shortage resolved in December 2024 and the semaglutide injection shortage resolved in February 2025. Shortage resolution is a determination the agency makes on supply data, which makes it a more reliable indicator than any manufacturer's projection.

Contract manufacturers have also expanded peptide synthesis and fill-finish capability, distributing production more widely and reducing geographic bottlenecks.

### Supply Chain Improvements

Beyond raw capacity increases, manufacturers have described supply chain enhancements:
...
The capacity expansion is expected to have significant market effects:

**Shortages resolved:** FDA removed tirzepatide injection from its shortage list in December 2024 and semaglutide injection in February 2025, ending a supply disruption that had persisted since 2022.
