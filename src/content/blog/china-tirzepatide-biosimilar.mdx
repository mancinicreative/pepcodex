...
tags: ["tirzepatide", "biosimilar", "china", "regulatory", "market-access"]
excerpt: "China's drug regulator grants approval to the first domestically manufactured tirzepatide biosimilar, signaling expanded access in the world's largest obesity market."
relatedPeptides: ["tirzepatide", "semaglutide", "mazdutide"]
relatedGlossary: ["glp-1", "gip", "type-2-diabetes", "obesity"]
sources:
