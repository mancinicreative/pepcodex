...
tags:
  ...
  - obesity
excerpt: >-
  Novo Nordisk submits New Drug Application for CagriSema, combining semaglutide
  with the amylin analog cagrilintide to achieve unprecedented 23% average
...
evidenceLevel: high
featured: false
metaTitle: "CagriSema NDA Filed: 23% Weight Loss (2025)"
metaDescription: >-
  Novo Nordisk files NDA for CagriSema, the first GLP-1 + amylin combo
  achieving 23% weight loss in trials. Mechanism, data, and timeline.
---
...
In REDEFINE 1, the estimated mean change in body weight from baseline to week 68 was −20.4% with CagriSema versus −3.0% with placebo, using the treatment-policy estimand [redefine-1-results]. The trial also included semaglutide-alone and cagrilintide-alone arms; the published abstract does not report their week-68 percentages, so they are not quoted here. A figure of 22.7% circulates for this trial — that is the trial-product estimand, not the primary published result.
