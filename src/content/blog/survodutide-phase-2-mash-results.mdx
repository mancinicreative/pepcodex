---
title: 'Survodutide in MASH: the Phase 2 Histology Data, and the Phase 3 That Followed'
...
tags:
  ...
  - dual-agonist
excerpt: >-
  Phase 2 data shows survodutide achieving 62% MASH resolution at 4.8mg dose,
  with even higher rates at 6.0mg. The dual GLP-1/glucagon agonist shows promise
  for liver disease.
relatedPeptides:
  - survodutide
  - semaglutide
...
featured: false
metaTitle: 'Survodutide and MASH: Phase 2 Histology, Phase 3 Readout'
metaDescription: >-
  Survodutide reached 62% MASH resolution at 4.8 mg in phase 2 biopsy data. The
  SYNCHRONIZE-MASLD phase 3 has now published — with two estimands that differ
...
The full compound record is in the [survodutide dossier](/peptides/survodutide); the closest published comparators are [semaglutide](/peptides/semaglutide) and, for the glucagon-containing class, [retatrutide](/peptides/retatrutide) and [pemvidutide](/peptides/pemvidutide).
