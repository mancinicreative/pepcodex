...
summary: >-
  ...
  The CORALreef trial program is enrolling approximately 17,000 patients.
  Phase 2 data showed greater than 60% LDL-C reduction. Would be the first
  oral peptide-based PCSK9 drug if approved.
sources:
  count: 12
  human: 8
  preclinical: 4
...
metaDescription: >-
  Evidence-graded review of MK-0616. Oral macrocyclic PCSK9 inhibitor in Phase 3 with >60% LDL-C reduction. Updated Apr 2026.
interactions: []
regulatoryStatus:
  status: investigational
  lastUpdated: '2026-04-13'
  notes: >-
    Phase 3 CORALreef program enrolling ~17,000 patients (Merck). No NDA
    filed yet. Potential first oral PCSK9 inhibitor.
ratings:
  researchDepth: 4
  globalCoverage: 4
