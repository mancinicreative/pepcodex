...
const aliases = ["amycretin", "AOD-9604", "AOD9604", "AOD 9604"];
...
const ctSearch = await get(
  `https://clinicaltrials.gov/api/v2/studies?query.term=${ctq}&pageSize=20&fields=NCTId,BriefTitle,OfficialTitle,OverallStatus,Phase,HasResults,EnrollmentCount,Condition`
);
console.log("===== CT.GOV SEARCH AOD-9604 STATUS", ctSearch.status, "=====");
console.log(ctSearch.text.slice(0, 4000));
