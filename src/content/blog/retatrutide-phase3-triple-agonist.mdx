...
tags: ["retatrutide", "phase-3", "triple-agonist", "obesity", "eli-lilly"]
excerpt: "Eli Lilly announces positive topline results from the TRIUMPH phase 3 program, with retatrutide demonstrating unprecedented weight loss efficacy in adults with obesity."
