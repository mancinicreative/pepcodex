...
summary: >-
  ...
  expressed in response to mechanical stress on muscle tissue. Named as one
  of five FDA Category 2 restricted peptides. Lacks clinical trial data
  despite popularity in fitness communities.
sources:
  count: 12
  human: 1
  preclinical: 11
...
metaDescription: >-
  Evidence-graded review of PEG-MGF. IGF-1 splice variant restricted by FDA (Category 2). Preclinical only. Updated Apr 2026.
interactions:
  - peptide: igf-1-lr3
    type: caution
    description: >-
      Both are IGF-1-related peptides. PEG-MGF is a splice variant while
      IGF-1 LR3 is the extended form. Overlapping growth factor signaling
      could increase proliferative risk.
  - peptide: mk-677
    type: caution
    description: >-
      MK-677 increases endogenous GH and IGF-1. Combining with exogenous
      PEG-MGF could lead to excessive growth factor stimulation.
regulatoryStatus:
  status: research-only
  lastUpdated: '2026-04-13'
  notes: >-
    Designated FDA Category 2 (restricted from compounding, pending formal
    rule publication) due to safety concerns and lack of clinical data. Not
...
ratings:
  ...
  reviewNotes: "Preclinical only. FDA Category 2 restricted. Fitness community interest exceeds evidence."
---
