...
tags: ["cagrisema", "cagrilintide", "semaglutide", "obesity", "nda"]
excerpt: "Novo Nordisk files NDA for CagriSema, combining semaglutide with amylin analog cagrilintide, after Phase 3 trials showed up to 25% weight loss in obesity patients."
relatedPeptides: ["semaglutide", "tirzepatide", "cagrilintide"]
relatedGlossary: ["glp-1", "amylin", "obesity"]
sources:
