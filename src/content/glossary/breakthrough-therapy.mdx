...
| Orforglipron | Eli Lilly | Obesity | Approved (Foundayo, 1 April 2026) |

Breakthrough Therapy designations are announced by sponsors rather than published in a searchable FDA register, so the "Granted" entries above rest on company statements. A designation expedites development and review; it is not an approval, and it is not a finding that the drug works.
