---
title: 'SURMOUNT-5: Tirzepatide −20.2% vs Semaglutide −13.7%'
...
tags:
  ...
  - head-to-head
excerpt: >-
  SURMOUNT-5 (PMID 40353578): tirzepatide −20.2% vs semaglutide −13.7% at 72
  weeks, open-label. The 6.5-point gap is the published primary end point. How
  to read it next to the existing compare page.
relatedPeptides:
  - tirzepatide
  - semaglutide
relatedGlossary:
...
evidenceLevel: high
featured: false
metaTitle: 'SURMOUNT-5: 20.2% vs 13.7%, Open-Label Head-to-Head'
metaDescription: >-
  Tirzepatide −20.2% vs semaglutide −13.7% at 72 weeks (PMID 40353578).
  Open-label. Side-by-side on the compare page; 2026 overview on the twin post.
---
...
For side-by-side context beyond the trial, see our [tirzepatide vs semaglutide comparison](/compare/tirzepatide-vs-semaglutide), the 2026 decision post [semaglutide vs tirzepatide](/blog/semaglutide-vs-tirzepatide-2026), and the plain-language pages [How to Read the Tirzepatide Record](/blog/what-is-tirzepatide) and [How to Read the Wegovy Evidence](/blog/what-is-wegovy).

If you want to log the same endpoints this trial used — waitlist only, no store listing — [join the PepTracker waitlist](/newsletter).
