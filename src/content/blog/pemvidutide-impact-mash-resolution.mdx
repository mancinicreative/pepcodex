...
tags:
  ...
  - dual-agonist
excerpt: >-
  Altimmune reports pemvidutide achieved 59% MASH resolution without fibrosis
  worsening in the IMPACT trial, positioning the GLP-1/glucagon dual agonist as
  a potential breakthrough for liver disease.
relatedPeptides:
  - semaglutide
  - tirzepatide
  - survodutide
...
featured: false
metaTitle: "Pemvidutide IMPACT Trial: 59% MASH Resolution"
metaDescription: >-
  IMPACT Phase 2 trial shows pemvidutide achieves 59% MASH resolution without fibrosis worsening, setting a new efficacy benchmark for liver disease treatment.
---
