...
const aliases = ["amycretin", "CagriSema", "cagrilintide"];
...
const extra = [
  ["REDEFINE1", `"REDEFINE 1" AND cagrilintide`],
  ["REDEFINE2", `"REDEFINE 2" AND cagrilintide`],
  ["ORAL UID", "40550229[uid]"],
  ["SC UID", "40550231[uid]"],
  ["REDEFINE1 UID", "40544433[uid]"],
];
...
const known = "40550229,40550231,40544433";
...
const ncts = ["NCT05369390", "NCT06064006", "NCT05567796"];
...
for (const name of ["amycretin", "cagrilintide", "cagrisema"]) {
  await sleep(200);
  const fda = await get(
