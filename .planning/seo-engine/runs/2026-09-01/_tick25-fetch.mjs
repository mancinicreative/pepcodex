...
const searches = [
  ["TRIUMPH-1 retatrutide weight", "TRIUMPH-1[Title] AND retatrutide"],
  ["TRIUMPH retatrutide", "TRIUMPH[Title] AND retatrutide"],
  ["retatrutide 28.7", "retatrutide[Title] AND 28.7"],
  ["survodutide SYNCHRONIZE-1", "SYNCHRONIZE-1[Title] AND survodutide"],
  ["survodutide SYNCHRONIZE-MASLD", "SYNCHRONIZE-MASLD[Title] AND survodutide"],
  ["survodutide MASH phase 2", "survodutide[Title] AND MASH"],
  ["survodutide 46-week obesity", "survodutide[Title] AND obesity AND 46"],
  ["retatrutide phase 2 obesity", "retatrutide[Title] AND obesity AND phase"],
];
...
const ids = "37366315,38330987,42253238,41090431,42252333";
const fetchUrl =
