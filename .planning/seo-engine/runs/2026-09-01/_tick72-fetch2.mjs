/**
 * TICK72 fetch2: NCT details + openFDA.
 */
...
async function main() {
  console.log("TICK72 fetch2 start", new Date().toISOString());
  ...
  const fdaQueries = [
    ["GENERIC 5-amino-1mq", 'openfda.generic_name:"5-amino-1mq"'],
    ["GENERIC 5-amino-1-methylquinolinium", 'openfda.generic_name:"5-amino-1-methylquinolinium"'],
