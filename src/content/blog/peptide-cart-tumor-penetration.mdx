...
tags: ["car-t", "peptide-conjugate", "immunotherapy", "solid-tumors", "cancer"]
excerpt: "Novel approach using tumor-penetrating peptides to enhance CAR-T cell infiltration demonstrates promising results against solid tumors in preclinical and early clinical studies."
relatedPeptides: []
relatedGlossary: ["cell-penetrating-peptide", "immunotherapy", "car-t-cell"]
sources:
