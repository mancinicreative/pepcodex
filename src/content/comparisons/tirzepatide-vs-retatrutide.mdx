...
metaDescription: >-
  Head-to-head evidence comparison of Tirzepatide and Retatrutide. Research data, citations, and key differences reviewed.
faqs:
  ...
  - question: "Which has greater weight loss, tirzepatide or retatrutide?"
    answer: "In clinical trials, retatrutide showed up to 24.2% weight loss at 48 weeks (Phase 2) compared to tirzepatide's 20.9% at 72 weeks (Phase 3), though direct comparison is limited by different trial durations."
...
| **Max Weight Loss** | ~20.9% (SURMOUNT-1) | ~24.2% (Phase 2) |
...
|--------|-------------|-------------|
| **Maximum Weight Loss** | ~20.9% | ~24.2% (Phase 2) |
...
| **FDA Status** | Approved | Phase 3 |
| **Max Weight Loss** | 20.9% | 24.2% (Phase 2) |
...
3. **Phase 2 shows promise:** Retatrutide 24.2% vs tirzepatide 20.9% weight loss
