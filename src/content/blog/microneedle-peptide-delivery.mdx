...
tags: ["drug-delivery", "microneedle", "peptide-technology", "clinical-trial"]
excerpt: "A novel microneedle patch system for peptide delivery has entered clinical trials, promising painless, self-administered peptide therapy without traditional injections."
relatedPeptides: ["semaglutide", "tirzepatide"]
relatedGlossary: ["subcutaneous", "bioavailability", "clinical-trial"]
sources:
