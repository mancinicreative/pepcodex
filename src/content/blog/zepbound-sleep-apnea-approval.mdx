...
tags:
  ...
  - glp-1
excerpt: >-
  FDA approves Zepbound (tirzepatide) for moderate-to-severe obstructive sleep
  apnea in adults with obesity, marking the first medication approved
...
evidenceLevel: high
featured: false
metaTitle: 'Zepbound for Sleep Apnea: FDA Approval and Data'
metaDescription: >-
  The FDA approved Zepbound (tirzepatide) for obstructive sleep apnea in adults
  with obesity in December 2024. SURMOUNT-OSA cut breathing events by up to 63%.
---

The FDA approved Zepbound ([tirzepatide](/peptides/tirzepatide)) on 20 December 2024, under an efficacy supplement to NDA 217806, for the treatment of moderate-to-severe obstructive sleep apnea (OSA) in adults with obesity. This approval marks a significant expansion of GLP-1/GIP agonist indications and represents the first medication approved specifically for OSA, a condition that has historically been treated primarily with CPAP machines.
...
Coverage varies by payer and continues to evolve. At launch, the list price was approximately $1,000/month without insurance, and prior authorization requirements — such as documenting CPAP intolerance or preference — are common for this medication class.
...
- Heart failure (HFpEF)
- **Obstructive sleep apnea** (tirzepatide, December 2024)
- Chronic kidney disease ([semaglutide](/peptides/semaglutide), after the [FLOW trial](/blog/flow-trial-semaglutide-kidney-protection))
- MASH (semaglutide, now approved)

The pipeline is following the same path: retatrutide, a triple agonist, is being studied in obstructive sleep apnea in the TRIUMPH phase 3 program [triumph-osa-rationale].
...
For the trial data behind the approval, see our [SURMOUNT-OSA results breakdown](/blog/tirzepatide-surmount-osa), the plain-language [What is Zepbound?](/blog/what-is-zepbound) guide, and the full [tirzepatide dossier](/peptides/tirzepatide).
