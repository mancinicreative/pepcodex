/**
 * TICK55 cited-only fetch. Per-alias esearch (never OR-joined).
 * Amycretin oral/SC + retatrutide phase 2 + TRIUMPH design + TRANSCEND-T2D-1.
 */
...
function printAbstracts(xml) {
  ...
  for (const c of parts) {
    ...
    const need = {
      ...
      "41090431": ["retatrutide"],
      "42250575": ["retatrutide"],
      "42608321": ["retatrutide"],
    }[pm] || [];
...
const aliases = [
  ...
  ["amycretin AND retatrutide", `"amycretin" AND "retatrutide"`],
  ["TRIUMPH-1 title", `"TRIUMPH-1"[Title]`],
  ["TRIUMPH-1 retatrutide weight", `"TRIUMPH-1" retatrutide weight`],
  ["retatrutide title AND 28.7", `retatrutide[Title] AND 28.7`],
  ["oral uid", "40550229[uid]"],
  ["sc uid", "40550231[uid]"],
  ["p2 uid", "37366315[uid]"],
  ["triumph design uid", "41090431[uid]"],
  ["transcend uid", "42250575[uid]"],
  ["biomarkers uid", "42608321[uid]"],
];
...
const known = "40550229,40550231,37366315,41090431,42250575,42608321";
...
const ncts = ["NCT05369390", "NCT06064006", "NCT04881760", "NCT06354660"];
