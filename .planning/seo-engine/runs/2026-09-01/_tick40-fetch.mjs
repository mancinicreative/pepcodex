...
const aliases = ["amycretin", "VK2735"];
...
const extra = [
  ["VK-2735", `"VK-2735"`],
  ["VENTURE VK2735", `"VENTURE" VK2735`],
  ["VANQUISH VK2735", `"VANQUISH" VK2735`],
  ["ORAL UID", "40550229[uid]"],
  ["SC UID", "40550231[uid]"],
  ["VENTURE UID", "41508550[uid]"],
];
...
const known = "40550229,40550231,41508550";
...
for (const name of ["amycretin", "vk2735"]) {
  await sleep(200);
  const fda = await get(
