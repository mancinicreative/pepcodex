...
tags: ["orforglipron", "oral-glp1", "obesity", "eli-lilly", "non-peptide"]
excerpt: "Updated ATTAIN program data confirms orforglipron achieves 14% weight loss without injection, validating the non-peptide oral GLP-1 approach for obesity treatment."
relatedPeptides: ["semaglutide", "tirzepatide", "orforglipron"]
relatedGlossary: ["glp-1", "bioavailability", "receptor-agonist", "obesity"]
sources:
