...
evidenceLevel: low
featured: false
metaTitle: "Semax Ischemic Stroke: Rat Data vs Human Trial Evidence"
metaDescription: >-
  Rat stroke model: infarct volume down 62% (pre-treatment), 48% (acute),
  31% (delayed). No Western randomized human trial — see the translation
  gap.
---
