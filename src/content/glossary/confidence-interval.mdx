...
- Weight change: -14.9% vs -2.4% with placebo
- Treatment difference: -12.4 percentage points (95% CI: -13.4 to -11.5)
- Interpretation: the true added effect of semaglutide over placebo likely falls between 11.5 and 13.4 percentage points
- Narrow CI indicates precise estimate

**SURMOUNT-1 (Tirzepatide 15 mg):**
- Weight change: -20.9% (95% CI: -21.8% to -19.9%)
- Interpretation: True effect between 19.9% and 21.8%
...
CIs help clinicians understand uncertainty. A narrow CI around a large effect provides confidence the treatment works well. A wide CI suggests results could vary considerably. A lower bound close to no effect is what makes a result fragile, however impressive the point estimate looks.
