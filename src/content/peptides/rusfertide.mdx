...
summary: >-
  ...
  polycythemia vera. Phase 3 VERIFY trial demonstrated 77% hematocrit
  response rate. Developed by Protagonist Therapeutics (acquired by Takeda).
sources:
  count: 18
  human: 12
  preclinical: 6
...
metaDescription: >-
  Evidence-graded review of rusfertide (PTG-300). Hepcidin mimetic in FDA Priority Review for polycythemia vera. 77% Phase 3 response rate.
interactions: []
regulatoryStatus:
